import{i as h,a as u,x as o,r as f,p as v,n as p,b as y,d as k}from"./page.css-C0fZx8p3.js";const w=h`
  .trip {
    display: grid;
    gap: 1rem;
  }
...
`,m={styles:w};var $=Object.defineProperty,c=(a,t,s,e)=>{for(var r=void 0,n=a.length-1,l;n>=0;n--)(l=a[n])&&(r=l(t,s,r)||r);return r&&$(t,s,r),r};const g=class g extends u{render(){const t=this.bookings?this.bookings.split(",").map(e=>e.trim()).filter(Boolean):[],s=this.photos?this.photos.split(",").map(e=>e.trim()).filter(Boolean):[];return o`
    ...
    `}};g.styles=[f.styles,v.styles,m.styles,h`
      :host {
        display: flex;
        gap: 1rem;
        padding: 1rem;
    ...
    `];let i=g;c([p()],i.prototype,"date");c([p()],i.prototype,"location");c([p()],i.prototype,"itinerary");c([p()],i.prototype,"bookings");c([p()],i.prototype,"photos");customElements.define("trip-day",i);var O=Object.defineProperty,x=(a,t,s,e)=>{for(var r=void 0,n=a.length-1,l;n>=0;n--)(l=a[n])&&(r=l(t,s,r)||r);return r&&O(t,s,r),r};async function z(a){const t=await fetch(a);if(!t.ok)throw new Error(`Failed to fetch ${a}: ${t.status}`);return await t.json()}const b=class b extends u{constructor(){super(...arguments),this.data=[]}connectedCallback(){super.connectedCallback(),this.src&&z(this.src).then(t=>this.data=t).catch(t=>console.error(t))}render(){return this.data.length===0?o``:o` <div class="trip">
      ${this.data.map(t=>o`
          ...
          ></trip-day>
        `)}
    </div>`}};b.styles=[f.styles,v.styles,m.styles,h``];let d=b;x([p()],d.prototype,"src");x([y()],d.prototype,"data");customElements.define("list-day-page",d);k({"trip-day":i,"list-day-page":d});
